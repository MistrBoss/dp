...
%\usepackage{caption}	% vylepšení práce s popisky obrázků či tabulek
...
\lstset{
	...
	style=Matlab-editor,
	basicstyle=\linespread{0.8}\tiny\mlttfamily,	% Use small true type font
	keywordstyle=[2]\color{Purple},         		% MATLAB function arguments purple
	stringstyle=\color{Purple},             		% Strings are purple
	tabsize=4,                              		% 5 spaces per tab	inputencoding=utf8,
	extendedchars=\true,
%	inputencoding=utf8x,
}


\lstloadlanguages{Java, Matlab}
...
% Příkaz pro vysázení seznamu zdrojového kódu
\def\seznamscript{
	\clearpage
	\ifczech
		\addcontentsline{toc}{section}{Seznam zdrojového kódu}
	\else \ifenglish
...
\newcommand{\zadani}{
	\clearpage
	\includegraphics[width=16.5cm]{scan/zadani1.jpg}
	
	\clearpage
	\includegraphics[width=16.5cm]{scan/zadani2.jpg}
...
\def\thelstlisting{\arabic{lstlisting}}      	% číslování tabulek typu (y)
...
\renewcommand*\l@lstlisting{\@dottedtocline{1}{0em}{5.0em}}
...
\newcommand{\nastavjazyk}[1]{
	...
	\ifczech
		...
		\addto\captionsczech{\renewcommand{\lstlistlistingname}{\MakeTextUppercase{Seznam zdrojového kódu}}}
		\addto\captionsczech{\renewcommand{\figurename}{Obr.}}
		\addto\captionsczech{\renewcommand{\tablename}{Tab.}}
		\addto\captionsczech{\renewcommand{\lstlistingname}{Kod.}}
	\else \ifenglish
...
\newcommand{\prohlaseni}{{
	\clearpage
	\includegraphics[width=16.5	cm]{scan/prohlaseni.jpg}
}}
