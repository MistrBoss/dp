...
\seznamlit{
  ...
  \bibitem{md5}\it{MD5. In: Wikipedia: the free encyclopedia} [online]. San Francisco (CA): Wikimedia Foundation, 2001- [cit. 2018-05-08]. Dostupné z~WWW: \url{https://en.wikipedia.org/wiki/MD5}
  
  \bibitem{brightness-matrix}\it{Computer vision} [online]. [cit. 2018-05-08]. Dostupný z~WWW: \url{http://midas.uamt.feec.vutbr.cz/ZVS/Exercise02/content_cz.php}.
  \bibitem{fftw}\it{FFTW} [online]. [cit. 2018-05-08]. Dostupný z~WWW: \url{http://www.fftw.org}.
  \bibitem{cmake}\it{CMake} [online]. [cit. 2018-05-08]. Dostupný z~WWW: \url{https://cmake.org}.
}
